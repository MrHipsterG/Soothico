...
smithing.removeByName("create_stuff_additions:tuned_brass_moped_recipe");
MechanicalCrafterManager.removeByName("create_stuff_additions:brass_moped_recipe") as void;
craftingTable.removeByName("create_stuff_additions:quartz_crusher_recipe");